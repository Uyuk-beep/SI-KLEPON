...
/* Koreksi untuk memastikan dropdown profil selalu terlihat di mobile */
@media (max-width: 1023px) { /* Target layar di bawah 'lg' */
    .profile-dropdown { display: flex !important; }
}
